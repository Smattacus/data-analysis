function A = plotRadT(path, suffix, offset)
%Generates a plot of temperature vs angle of a plasma. This takes into account
...
tn = sprintf('Radius vs Electron Temp plot for LMP Run %s', suffix);
title(tn);